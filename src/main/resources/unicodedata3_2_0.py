data_3_2_0 = """0000;<control>;Cc;0;BN;;;;;N;NULL;;;;
...
def init():
    ...
    #print(os.path.join(my_path,'UnicodeData320.txt'))
    #with open(os.path.join(my_path,'UnicodeData320.txt'), "rb") as f:
    #    init_unicodedata(StringIO.StringIO(f.read()))
    #init_unicodedata(StringIO.StringIO(loader.get_data(os.path.join(my_path,'UnicodeData320.txt'))))
    init_unicodedata(StringIO.StringIO(data_3_2_0))
