...
import dk.atomit.EasyJSON.parser.ParseException;
...
public class JSONValue {
	 ...
	 * 
	 * @see dk.atomit.EasyJSON.parser.JSONParser#parse(Reader)
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see dk.atomit.EasyJSON.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	dk.atomit.EasyJSON.JSONObject,
